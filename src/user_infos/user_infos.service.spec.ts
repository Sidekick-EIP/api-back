...
describe("UserInfoService", () => {
	...
	it("should create user infos", async () => {
		...
		const userInfos1 = await service.setUserInfo(userInfos, "jestUserInfos@gmail.com")
	...
	it("should update user infos", async () => {
		...
		const newUserInfo = await service.updateInfos(userInfosEdit, "jestUserInfos@gmail.com")
	...
	it("should get user infos from Email", async () => {
		...
		await service.setUserInfo(userInfos, "jestUserInfos@gmail.com")

		service.getUserInfoById("cet email n existe pas")
	...
	it("should get user infos of Sidekick", async () => {
		...
		await service.setUserInfo(userInfos, "jestUserInfosSidekick@gmail.com")

		service.getSidekickInfo("cet email n existe pas")
		.then((infos) => expect(infos).toBeUndefined())
		.catch((err) => expect(err.status).toBe(404));
		...
		const sidekickInfos = await service.getSidekickInfo("jestUserInfos@gmail.com")
